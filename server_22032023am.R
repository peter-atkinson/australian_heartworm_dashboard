function(input,output,session){
  ...
  output$disclaimer <- renderUI({
    tagList(tags$link(rel = "stylesheet", type = "text/main/css", href = "css/main.css"),
            wellPanel(
  ...
  output$standard <- renderUI({
    tagList(tags$link(rel = "stylesheet", type = "text/css", href = "css/main.css"),
            ...
            fluidRow(column(9, style = "margin-bottom: 50px;",
                            wellPanel(
                              h3(
                     ...
                     column(3,
                            wellPanel(
                              h4(strong('What is happening in the capital cities?')), tableOutput("capital.cities")
                            ))),
            fluidRow(column(
              12,
